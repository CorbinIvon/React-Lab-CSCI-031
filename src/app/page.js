...
export default async function Home() {
  ...
  return (
    <>
      <Navbar />
      <Title Title="Home" BannerUrl="https://i.pinimg.com/originals/92/c1/2a/92c12ad4c4f3be78da8ccaa1d1481eda.png" />
      <div className="flex justify-center place-items-center">
        <div className="flex-center px-96">
          <section>
          ...
          <section>
            ...
            <p className={pageParagraphStyle}>
              All project information will be located in the blog section of this site. It will hold blogs, projects,
              and similar data. The blog section will be updated regularly with new projects and blogs as I complete
              them.
            </p>
          </section>
        </div>
